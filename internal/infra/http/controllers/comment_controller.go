...
func (c CommentController) Save(ctx echo.Context) error {
	...
	return FormatedResponse(ctx, http.StatusCreated, commentDto.DomainToDto(createdComment))
}
...
func (c CommentController) Find(ctx echo.Context) error {
	...
	return FormatedResponse(ctx, http.StatusOK, commentDto.DomainToDto(comment))
}
...
func (c CommentController) FindAll(ctx echo.Context) error {
	...
	return FormatedResponse(ctx, http.StatusOK, commentDto.DomainToDtoCollection(comments))
}
...
func (c CommentController) Update(ctx echo.Context) error {
	...
	return FormatedResponse(ctx, http.StatusOK, commentDto.DomainToDto(updatedComment))
}
